...
export default function ChatbotScreen() {
  ...
  const sendMessage = async () => {
    ...
    try {
      const response = await fetch('https://empowerfam.onrender.com/', {
        method: 'POST',
      ...
      const botMessage: Message = { text: data.reply || "I'm not sure how to respond yet.", sender: 'bot' };
      setMessages(prev => [...prev, botMessage]);
    } catch (error) {
      setMessages(prev => [...prev, { text: "Error: Couldn't reach the assistant.", sender: 'bot' }]);
    }
  };
